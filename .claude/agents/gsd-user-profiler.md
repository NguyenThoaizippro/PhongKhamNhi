...
<reference>
@/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/user-profiling.md` to load:
