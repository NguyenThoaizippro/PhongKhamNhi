...
<required_reading>
Read `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
