...
Reference full template: `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/state.md`.
