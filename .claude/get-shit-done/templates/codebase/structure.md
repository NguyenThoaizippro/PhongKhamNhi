...
- Usage: Reference from command with `@/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/nguyenthoai/Project/PhongKhamDeMen/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/nguyenthoai/Project/PhongKhamDeMen/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
