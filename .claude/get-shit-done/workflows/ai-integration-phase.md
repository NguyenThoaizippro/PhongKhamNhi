...
<required_reading>
@/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/ai-frameworks.md
@/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/nguyenthoai/Project/PhongKhamDeMen/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/nguyenthoai/Project/PhongKhamDeMen/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/nguyenthoai/Project/PhongKhamDeMen/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/nguyenthoai/Project/PhongKhamDeMen/.claude/agents/gsd-eval-planner.md for instructions.
