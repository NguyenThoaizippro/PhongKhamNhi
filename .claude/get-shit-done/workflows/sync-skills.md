...
INSTALL_JS_GLOBAL="/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
