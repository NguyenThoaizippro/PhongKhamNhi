...
```bash
INIT=$(node "/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/spec.md.
