...
```
Agent(
  prompt="Read /home/nguyenthoai/Project/PhongKhamDeMen/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/SECURITY.md`
