...
- **Global scope**: `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/notes/`)
...
2. Glob `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/nguyenthoai/Project/PhongKhamDeMen/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/notes/` — works in any directory
