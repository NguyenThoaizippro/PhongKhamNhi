...
```bash
INIT=$(node "/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
