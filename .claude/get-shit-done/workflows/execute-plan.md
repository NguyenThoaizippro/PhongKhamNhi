...
@/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/nguyenthoai/Project/PhongKhamDeMen/.claude/get-shit-done/templates/summary.md`.
